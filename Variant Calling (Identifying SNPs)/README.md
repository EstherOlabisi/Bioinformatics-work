## Scripts: all shell scripts run in Compute Canada HPC clusters.
* __run_sam_to_bam.sh:__ This script converts sam files to bam files and then sorts and indexes the bam files for variant calling.
